...
?>
    ...
    <!--Banner-->
    <section>
        <div class="csi-banner csi-banner-inner csi-delivery">
            <div class="csi-inner">
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12">
    ...
    <section>
        <div class="csi-single-item">
            <div class="csi-inner">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="csi-singleitem-content">
                                <h1 class="title">Carajás Geisel</h1>
                                <!--<h4 class="subtitle">Mexican Food</h4>-->
                                <h3 class="price">(83) 3191-4405</h3>
                                <p>
                                    Rua Motorista Aldovandro Amâncio - Geisel
                                </p>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="csi-singleitem-content">
                                <h1 class="title">Carajás Intermares</h1>
                                
                                <h3 class="price">(83) 3191-4405</h3>
                                <p>
                                    R. Mar do Caribe, s/n - Portal do Poço
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="row" style="margin-top:40px;">
                        <div class="col-sm-6">
                            <div class="csi-singleitem-content">
                                <h1 class="title">Manaíra</h1>
                               
                                <h3 class="price">(83)3245-7105</h3>
                                <p>
                                   Rua. Reinaldo Tavares de Melo, 99 - Manaíra
                                </p>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="csi-singleitem-content">
                                <h1 class="title">Bessa</h1>
                                
                                <h3 class="price">(83) 3245-3780 | 3245-4401 | 3191-4401</h3>
                               
                                <p>
                                    Av. Presidente Nilo Peçanha, 39 - Bessa 
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="row" style="margin-top:50px;" >
                        <div class="col-sm-12">
                            <div class="csi-singleitem-content" style="text-align: center; margin-bottom: 30px;">
                                
                                <h1 class="title2">Realizar seu Pedido também pelo WhatsApp: (83) 98146-4401</h1>
                                
                                 <a href="https://api.whatsapp.com/send?phone=5583981464401"  target="_blank">
          <img src="assets/img/icon-wpp.png" style="max-width: 100%;">
        </a>
                            </div>
                        </div>
         ...
         <a href="" class="icon_ifood_bottom" target="_blank">
