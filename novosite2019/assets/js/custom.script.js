        ...
        if (typeof google != 'undefined') {
            ...
            if (mapCanvasDefault.length) {
                mapCanvasDefault.googleMap({
                    ...
                    coords: [-7.0672391, -34.8421461, 17], // Map center (optional)
                ...
                mapCanvasDefault.addMarker({
                    coords: [-7.0672391, -34.8421461, 17], // GPS coords
                    title: 'PoliticX',
                    text: 'Av. Pres. Nilo Peçanha, 39 - Bessa',
            ...
            if (mapCanvasDefault.length) {
                ...
                mapCanvasDefault.addMarker({
                    coords: [-7.0672391, -34.8421461, 17], // GPS coords
                    title: 'PoliticX',
                    text: '1Av. Pres. Nilo Peçanha, 39 - Bessa',
                    icon: csi_path + '/assets/img/map/map-icon.png'
                });
            }
        }
