                        ...
                        <div class="col-xs-12">
                            <div class="csi-heading-area">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="active">Burger Mexicana</li>
                                </ul>
                            </div>
                        </div>
                    </div><!--//.ROW-->
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <figure class="single-thumb">
                                <img src="http://placehold.it/600x600" alt="Special Food">
                            </figure>
                        </div>
                        <div class="col-sm-6">
                            <div class="csi-singleitem-content">
                                <h1 class="title">Burger Mexicana</h1>
                                <h4 class="subtitle">Mexican Food</h4>
                                <h3 class="price">Price: <span>558 <b>$</b></span></h3>
                                <p>
